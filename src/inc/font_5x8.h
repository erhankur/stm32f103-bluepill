const unsigned char g_ChrTab[] = {
		...
		0x3D, 0x40, 0x20, 0x7D, 0x00,	// 129 (0x81) 'Å'
		...
		0x00, 0x00, 0x7C, 0x40, 0x00,	// 141 (0x8D) 'ç'
		0x70, 0x29, 0x24, 0x29, 0x70,	// 142 (0x8E) 'é'
		0x78, 0x2F, 0x25, 0x2F, 0x78,	// 143 (0x8F) 'è'
		0x7C, 0x54, 0x54, 0x55, 0x45,	// 144 (0x90) 'ê'
		...
		0x7E, 0x61, 0x5D, 0x43, 0x3F,	// 157 (0x9D) 'ù'
		0x12, 0xA5, 0xE5, 0x25, 0x1A,	// 158 (0x9E) 'û'
		...
		0x19, 0xA6, 0xA6, 0xA6, 0x7D,	// 167 (0xA7) 'ß'
		...
		0x08, 0x14, 0x00, 0x08, 0x14,	// 174 (0xAE) 'Æ'
		0x14, 0x08, 0x00, 0x14, 0x08,	// 175 (0xAF) 'Ø'
		...
		0x70, 0x28, 0x25, 0x29, 0x70,	// 181 (0xB5) 'µ'
		0x70, 0x29, 0x25, 0x29, 0x70,	// 182 (0xB6) '∂'
		0x70, 0x29, 0x25, 0x28, 0x70,	// 183 (0xB7) '∑'
		0x41, 0x5D, 0x55, 0x41, 0x3E,	// 184 (0xB8) '∏'
		0xFB, 0x00, 0xFF, 0x00, 0x00,	// 185 (0xB9) 'π'
		0xFF, 0x00, 0xFF, 0x00, 0x00,	// 186 (0xBA) '∫'
		0xFA, 0x02, 0xFE, 0x00, 0x00,	// 187 (0xBB) 'ª'
		0x0B, 0x08, 0x0F, 0x00, 0x00,	// 188 (0xBC) 'º'
		0x18, 0x24, 0x66, 0x24, 0x00,	// 189 (0xBD) 'Ω'
		0x29, 0x2A, 0x7C, 0x2A, 0x29,	// 190 (0xBE) 'æ'
		0x08, 0x08, 0xF8, 0x00, 0x00,	// 191 (0xBF) 'ø'
		...
		0x08, 0x08, 0x08, 0x08, 0x08,	// 196 (0xC4) 'ƒ'
		...
		0xFA, 0x02, 0xFA, 0x0A, 0x0A,	// 203 (0xCB) 'À'
		0xFF, 0x00, 0xFB, 0x0A, 0x0A,	// 204 (0xCC) 'Ã'
		0x0A, 0x0A, 0x0A, 0x0A, 0x0A,	// 205 (0xCD) 'Õ'
		0xFB, 0x00, 0xFB, 0x0A, 0x0A,	// 206 (0xCE) 'Œ'
		0x5D, 0x22, 0x22, 0x22, 0x5D,	// 207 (0xCF) 'œ'
		...
		0x00, 0x45, 0x7C, 0x45, 0x00,	// 216 (0xD8) 'ÿ'
		0x08, 0x08, 0x0F, 0x00, 0x00,	// 217 (0xD9) 'Ÿ'
		...
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	// 219 (0xDB) '€'
                    ...
                    0x12, 0xA5, 0xE5, 0x25, 0x1A,	// 158 (0x9E) 'û'
		0x0F, 0x0F, 0x0F, 0x0F, 0x0F,	// 223 (0xDF) 'ﬂ'
		...
		0x3A, 0x45, 0x46, 0x39, 0x00,	// 229 (0xE5) 'Â'
		0xFC, 0x20, 0x20, 0x1C, 0x00,	// 230 (0xE6) 'Ê'
                    //0x00, 0x00, 0x00, 0x00, 0x00,	// 231 (0xE7) 'Á'
                    0x1C, 0xA2, 0xE2, 0x22, 0x14,	// 135 (0x87) '?'
		0x22, 0x14, 0x08, 0x14, 0x22,	// 232 (0xE8) 'Ë'
		0x3C, 0x40, 0x41, 0x3D, 0x00,	// 233 (0xE9) 'È'
		0x3C, 0x41, 0x41, 0x3D, 0x00,	// 234 (0xEA) 'Í'
		0x3D, 0x41, 0x40, 0x3C, 0x00,	// 235 (0xEB) 'Î'
		0x00, 0x01, 0x7C, 0x40, 0x00,	// 236 (0xEC) 'Ï'
		0x9C, 0xA1, 0x60, 0x3D, 0x00,	// 237 (0xED) 'Ì'
		0x00, 0x02, 0x02, 0x02, 0x00,	// 238 (0xEE) 'Ó'
		0x00, 0x07, 0x03, 0x00, 0x00,	// 239 (0xEF) 'Ô'
                    //0x00, 0x08, 0x08, 0x08, 0x00,	// 240 (0xF0) '?'
                    0x19, 0xA6, 0xA6, 0xA6, 0x7D,	// 167 (0xA7) 'ß'
		0x00, 0x24, 0x2E, 0x24, 0x00,	// 241 (0xF1) 'Ò'
		0x00, 0x00, 0x00, 0x00, 0x00,	// 242 (0xF2) 'Ú'
		0x17, 0x0A, 0x34, 0x2A, 0x78,	// 243 (0xF3) 'Û'
		0x06, 0x09, 0x7F, 0x01, 0x7F,	// 244 (0xF4) 'Ù'
		0x22, 0x4D, 0x55, 0x59, 0x22,	// 245 (0xF5) 'ı'
                    //0x08, 0x08, 0x2A, 0x08, 0x08,	// 246 (0xF6) 'ˆ'
                    0x38, 0x45, 0x44, 0x39, 0x00,	// 148 (0x94) '?'
		...
		0x02, 0x0F, 0x00, 0x00, 0x00,	// 251 (0xFB) '˚'
                    ...
                    0x04, 0xAA, 0xEA, 0x2A, 0x10,	// 159 (0x9F) '?'
		0x00, 0x00, 0x00, 0x00, 0x00,	// 255 (0xFF) 'ˇ'
};
